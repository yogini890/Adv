  ...
  return (
    <footer className="bg-[#0D1B2A] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-sm mb-5">
              Strategic Legal Representation for Real Estate, Wealth & Commercial Disputes in Mumbai.
            </p>
        ...
        <div className="border-t border-[#1A2E42] mt-10 pt-6 flex flex-col sm:flex-row justify-center items-center gap-3">
